...
const Dot = ({ className }: { className: string }) => (
  <div className={`absolute rounded-full opacity-20 pointer-events-none ${className}`} />
);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-7">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-1">
                <Button
                  size="lg"
                  className="gap-2 font-semibold text-base px-7 shadow-lg shadow-primary/20"
                  onClick={() => navigate("/auth")}
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="gap-2 font-semibold text-base px-7"
                  onClick={() => navigate("/auth")}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-5">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Across Bukuru, Rayfield, Dadin Kowa, and beyond — irregular waste collection is a daily frustration for Plateau State residents. Drivers have no system. Residents have no visibility. Admins have no data.
              </p>
            ...
            <div className="space-y-5">
              ...
              <p className="text-muted-foreground leading-relaxed">
                EcoTrack gives residents real-time pickups, drivers a structured earning system, and city administrators the analytics dashboard they need to run a clean, modern Plateau State.
              </p>
              <div className="space-y-3">
                {[
              ...
              <Button className="gap-2 mt-2" onClick={() => navigate("/auth")} data-testid="problem-cta">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14 space-y-3">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto text-base">
              Whether you live on a quiet street in Rayfield or drive routes through Angwan Rogo — EcoTrack works for you.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Residents */}
            <div className="group rounded-2xl border border-border bg-card p-8 space-y-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-200">
              ...
              <Button className="w-full gap-2" onClick={() => navigate("/auth")} data-testid="card-cta-user">
                Get Started Free <ArrowRight className="h-4 w-4" />
              </Button>
            </div>

            {/* Drivers — featured */}
            <div className="group rounded-2xl bg-primary text-primary-foreground p-8 space-y-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-200 relative overflow-hidden">
              ...
              <div>
                ...
                <p className="text-sm text-primary-foreground/80 leading-relaxed">
                  Turn your vehicle into a real income. Accept pickup tasks near you, complete them, and get paid in Naira — straight to your account.
                </p>
              </div>
              ...
              <Button variant="secondary" className="w-full gap-2 font-semibold" onClick={() => navigate("/auth")} data-testid="card-cta-driver">
            ...
            <div className="group rounded-2xl border border-border bg-card p-8 space-y-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-200">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  A command centre for Plateau State's waste infrastructure — real-time bin maps, driver oversight, and revenue analytics in one dashboard.
                </p>
              </div>
              <ul className="space-y-2.5 text-sm text-muted-foreground">
      ...
      <section className="py-20 px-5 sm:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16 space-y-3">
            ...
            <p className="text-muted-foreground">No stress. No long forms. Start getting clean in minutes.</p>
          </div>
              ...
              {[
                {
                  ...
                  desc: "Pick your role — resident or driver — enter your phone number and basic details. No ID verification for residents.",
                },
                {
                  step: "02",
                  icon: <MapPin className="h-6 w-6" />,
                  title: "Request or accept a pickup",
                  desc: "Residents choose waste type and set location. Nearby drivers get notified instantly and accept the task.",
                },
                {
                  step: "03",
                  icon: <TrendingUp className="h-6 w-6" />,
                  title: "Get rewarded",
                  desc: "Residents earn eco points. Drivers earn Naira. Every completed pickup makes Jos a little cleaner.",
                },
              ].map((item) => (
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              {
                name: "Emeka Okafor",
                location: "Bukuru, Jos South",
                role: "Driver · 3 months",
                initials: "EO",
                rating: 5,
                quote: "I was just driving without direction before. Now I open the app, see jobs near me, and I've made over ₦90,000 last month just doing pickups in the morning.",
              },
              {
                name: "Hajiya Fatima",
                location: "Dadin Kowa, Jos North",
                role: "Resident",
                initials: "HF",
                rating: 5,
              ...
              <div
                key={t.name}
                className="bg-card rounded-2xl border border-border p-6 space-y-4 hover:shadow-md transition-shadow"
              >
      ...
      <section className="py-20 px-5 sm:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14 space-y-3">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">Every feature is built around the real challenges of waste management in Nigerian cities.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={f.title} className="flex gap-4 p-5 rounded-2xl border border-border bg-card hover:shadow-sm hover:border-primary/20 transition-all">
            ...
            <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-8 items-center">
              <div className="space-y-4">
                ...
                <p className="text-primary-foreground/80 text-sm leading-relaxed">
                  Plateau State waste drivers on EcoTrack complete an average of 20 tasks per week — earning real Naira paid directly to them. No middle-man, no delay.
                </p>
                <Button
                  variant="secondary"
      ...
      <section className="py-24 px-5 sm:px-8 relative overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button
              size="lg"
              className="gap-2 px-10 text-base font-semibold shadow-lg shadow-primary/20"
              onClick={() => navigate("/auth")}
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground max-w-xs leading-relaxed">
                Plateau State's official smart waste management platform. Serving Jos, Bukuru, Barkin Ladi, Vom and beyond.
              </p>
            </div>
